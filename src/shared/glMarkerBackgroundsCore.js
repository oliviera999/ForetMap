export const MARKER_BACKGROUND_MODES = Object.freeze(['label', 'emoji', 'icon']);

export const MARKER_BACKGROUND_PRESETS = new Set(['transparent', 'classic']);

const HEX_COLOR_RE = /^#[0-9a-f]{6}$/i;

export const DEFAULT_MARKER_BACKGROUNDS = Object.freeze({
  label: 'transparent',
  emoji: 'transparent',
  icon: 'transparent',
});

export const CLASSIC_MARKER_BACKGROUNDS = Object.freeze({
  label: '#fb923c',
  emoji: 'rgba(255, 255, 255, 0.92)',
  icon: 'transparent',
});

export const CLASSIC_EMOJI_BOX_SHADOW = '0 1px 4px rgba(15, 23, 42, 0.18)';

export const TRANSPARENT_LABEL_TEXT_SHADOW =
...
export function normalizeMarkerBackgroundModeValue(value, fallback = 'transparent') {
...
export function normalizeMarkerBackgrounds(input) {
...
export function validateMarkerBackgrounds(input) {
...
export function resolveBackgroundCssValue(mode, settingValue) {
...
export function resolveMarkerBackgroundCssVars(backgrounds) {
