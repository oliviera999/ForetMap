...
export const STATE_LABELS = {
  ...
  [VISIT_MASCOT_STATE.SLEEP]: 'Sommeil',
  [VISIT_MASCOT_STATE.WAVE]: 'Salut',
  [VISIT_MASCOT_STATE.DANCE]: 'Danse',
  [VISIT_MASCOT_STATE.EAT]: 'Repas',
  [VISIT_MASCOT_STATE.SEARCH]: 'Recherche',
  [VISIT_MASCOT_STATE.SAD]: 'Triste',
  [VISIT_MASCOT_STATE.LOVE]: 'Cœur',
  [VISIT_MASCOT_STATE.POINT]: 'Désigne',
};
