...
const RELAUNCH_STEP = {
  ...
  body: 'Si tu me perds en route, ce « ? » me rappelle. J’arrive toujours en courant — je n’ai rien de mieux à faire, et je l’assume.',
  bodyTeacher:
  ...
  map: {
    ...
    steps: [
      ...
      },
      {
        ...
        body: 'Zoom, étiquettes, gestes : je règle ma vue ici avant de partir. Zoome un bon coup, tu vas voir des trucs que tu as piétinés toute l’année.',
        bodyTeacher:
      ...
      },
      {
        ...
        body: 'Clique une zone ou un repère : sa fiche dit quoi observer, et quoi y faire. Ce que tu notes aujourd’hui, quelqu’un le lira quand tu auras quitté ce lycée. Ça me retourne à chaque fois — alors écris mieux que moi.',
        placement: 'center',
        expression: 'grave',
      },
      RELAUNCH_STEP,
    ...
    steps: [
      {
        ...
        target: ACTIVE_NAV,
        title: 'Les tâches',
        body: 'Ici, tout ce qu’il y a à faire dehors. Je lis cette liste chaque matin, avant même d’avoir les yeux en face des trous.',
        bodyTeacher:
    ...
    steps: [
      {
        ...
        body: 'Le relevé de ce que tu as fait, semaine après semaine. Des chiffres, pas un jugement — et ils grimpent plus vite que tu ne crois, j’ai vérifié !',
        bodyTeacher:
    ...
    steps: [
      {
        ...
        target: ACTIVE_NAV,
        title: 'Les quiz',
        body: 'Des questions sur la forêt comestible. Se tromper ici ne coûte rien — c’est bien le seul endroit du site où j’ai le droit de me planter, alors j’en profite.',
        bodyTeacher:
    ...
    steps: [
      {
        ...
        target: ACTIVE_NAV,
        title: 'Le glossaire',
        body: 'Les mots de la permaculture et de l’écologie, expliqués sans détour. J’ai dit « mycorhize » de travers pendant des mois — autant t’épargner ça.',
        placement: 'auto',
        expression: 'parle',
      },
      RELAUNCH_STEP,
    ...
    steps: [
      {
        ...
        body: 'Qui mange qui : chaque trait est un lien réel entre deux espèces d’ici. La première fois que j’ai vu la toile entière, je suis resté planté devant comme un piquet — retire un fil et tout le reste bouge. Regarde qui tient à quoi avant de décider ce qui est utile.',
        placement: 'auto',
        expression: 'grave',
      },
      RELAUNCH_STEP,
    ...
    steps: [
      {
        ...
        target: ACTIVE_NAV,
        title: 'Les tutoriels',
        body: 'Des guides pratiques, en vidéo ou en fiche, pour les gestes qui s’apprennent mieux en regardant qu’en lisant. J’ai appris la taille comme ça : trois visionnages, deux branches de trop.',
        bodyTeacher:
