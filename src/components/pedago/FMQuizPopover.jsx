...
/**
 * Popover du contrôle de compréhension (ForetMap).
 *
 * Même interface que `DialogShell` — il s'y substitue par injection, sans que le
 * bouton d'accusé partagé ait à connaître l'un ou l'autre : Gnomes & Licornes
 * garde sa modale, ForetMap prend ce popover.
 *
 * Pourquoi un popover plutôt qu'une modale pleine largeur : la question surgit
 * par-dessus le tutoriel qu'on vient de lire, sans le masquer entièrement ni
 * donner l'impression d'un examen. Le vocabulaire visuel est celui du popover de
 * glossaire (`fm-glossary-popover`), déjà familier aux élèves.
 *
