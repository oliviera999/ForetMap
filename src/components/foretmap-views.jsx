...
import { PlantSpeciesPrefillPanel } from './biodiv/PlantSpeciesPrefillPanel.jsx';
import { PlantPhotoUploadGrid } from './biodiv/PlantPhotoUploadGrid.jsx';
  ...
  return (
    <div className="plant-edit-form fade-in">
      ...
      <PlantnetIdentifyPanel
        ...
        onToast={onToast}
      />
      <PlantSpeciesPrefillPanel saving={saving} form={form} setForm={setForm} onToast={onToast} />
