  ...
  return (
    <svg className="visit-gnome-svg" viewBox="0 0 128 148" role="presentation" focusable="false">
      ...
      <g className="visit-gnome-head">
        ...
        />
        <path
          d="M58 60 Q77 96 95 61 Q89 108 77 116 Q65 107 58 60 Z"
          fill={beardFill}
          stroke="#1a4731"
          strokeWidth="3"
        />
  ...
  return (
    <svg className="visit-spore-svg" viewBox="0 0 128 148" role="presentation" focusable="false">
      ...
      <g className="visit-spore-body">
        ...
        <path
          className="visit-spore-glow"
          d="M64 22 Q88 38 64 46 Q40 38 64 22"
          fill="#fef08a"
          opacity="0.55"
          stroke="#ca8a04"
          strokeWidth="1.5"
  ...
  return (
    <svg className="visit-tan-bird-svg" viewBox="0 0 128 148" role="presentation" focusable="false">
      ...
      <g className="visit-tan-bird-wing">
        <path
          d="M48 86 Q38 72 44 58 Q52 52 58 68 Q54 80 48 86 Z"
          fill="#d4bc9a"
          stroke="#111827"
          strokeWidth="2.6"
        />
        <path
          d="M50 82 Q44 70 50 62"
          fill="none"
          stroke="#111827"
          strokeWidth="1.8"
          strokeLinecap="round"
...
/** Renard au sac — variante visuelle pour mascotte « Renard 2 » (sprites découpés). */
function BackpackFox2VisitMascotSvg() {
  return (
    <svg
      className="visit-backpack-fox2-svg"
      viewBox="0 0 128 148"
      role="presentation"
      focusable="false"
    >
      <ellipse cx="64" cy="140" rx="28" ry="6" fill="rgba(26,71,49,0.15)" />
      <g className="visit-backpack-fox2-body">
        <path
          d="M42 106 Q34 80 50 60 Q64 42 88 50 Q104 56 104 78 Q104 100 88 112 Q66 124 42 106 Z"
          fill="#c2410c"
          stroke="#7c2d12"
          strokeWidth="3.4"
        />
        <path
          d="M60 86 Q74 96 90 84 Q84 106 70 110 Q56 102 60 86 Z"
          fill="#ffedd5"
          stroke="#7c2d12"
          strokeWidth="2.2"
        />
      </g>
      <g className="visit-backpack-fox2-head">
        <path
          d="M54 56 Q52 34 70 30 Q88 34 86 56 Q84 74 68 76 Q52 72 54 56 Z"
          fill="#ea580c"
          stroke="#7c2d12"
          strokeWidth="3"
        />
        <path d="M48 48 L44 36 L56 42 Z" fill="#ea580c" stroke="#7c2d12" strokeWidth="2" />
        <path d="M86 48 L90 36 L78 42 Z" fill="#ea580c" stroke="#7c2d12" strokeWidth="2" />
        <ellipse cx="62" cy="58" rx="5" ry="6" fill="#fff" stroke="#7c2d12" strokeWidth="1.6" />
        <ellipse cx="72" cy="58" rx="5" ry="6" fill="#fff" stroke="#7c2d12" strokeWidth="1.6" />
        <circle cx="63" cy="59" r="2.2" fill="#1f2937" />
        <circle cx="73" cy="59" r="2.2" fill="#1f2937" />
        <path
          d="M64 68 Q70 72 76 68"
          fill="none"
          stroke="#7c2d12"
          strokeWidth="2"
          strokeLinecap="round"
      ...
      <g className="visit-backpack-fox2-bag">
        <rect
          x="76"
          y="70"
          width="24"
      ...
      <g className="visit-backpack-fox2-tail">
        <path
          d="M30 94 Q14 86 20 70 Q26 58 38 66 Q34 82 30 94 Z"
          fill="#c2410c"
          stroke="#7c2d12"
          strokeWidth="2.8"
        />
...
function BackpackFoxVisitMascotSvg() {
  return (
    <svg
      className="visit-backpack-fox-svg"
      viewBox="0 0 128 148"
      role="presentation"
      focusable="false"
    >
      ...
      <g className="visit-backpack-fox-body">
        ...
        />
        <path
          d="M58 88 Q72 98 88 86 Q82 108 68 112 Q54 104 58 88 Z"
          fill="#ffedd5"
          stroke="#7c2d12"
          strokeWidth="2.2"
        />
      ...
      <g className="visit-backpack-fox-head">
        <path
          d="M52 56 Q50 34 70 30 Q88 34 86 56 Q84 74 68 76 Q52 72 52 56 Z"
          fill="#f97316"
          stroke="#7c2d12"
          strokeWidth="3"
        />
      ...
      <g className="visit-backpack-fox-tail">
        <path
          d="M28 96 Q12 88 18 72 Q24 60 36 68 Q32 84 28 96 Z"
          fill="#ea580c"
          stroke="#7c2d12"
          strokeWidth="2.8"
        />
  ...
  return (
    <svg className="visit-olu-svg" viewBox="0 0 128 148" role="presentation" focusable="false">
      ...
      <g className="visit-olu-body">
        <path
          d="M38 110 Q28 82 43 60 Q56 42 78 50 Q95 56 95 78 Q95 101 78 112 Q56 122 38 110 Z"
          fill="#d97745"
          stroke="#4a2b18"
          strokeWidth="3.6"
        />
      ...
      <g className="visit-olu-head">
        <path
          d="M48 58 Q47 38 65 32 Q82 37 80 58 Q79 75 64 78 Q50 74 48 58 Z"
          fill="#e08a55"
          stroke="#4a2b18"
          strokeWidth="3.2"
        />
      ...
      <g className="visit-olu-tail">
        <path
          d="M88 92 Q111 90 113 106 Q100 116 85 109 Z"
          fill="#d97745"
          stroke="#4a2b18"
          strokeWidth="3"
        />
...
/**
 * @param {object} props
 * @param {'gnome'|'spore'|'vine'|'moss'|'seed'|'swarm'|'sprout'|'scrap'|'olu'|'tanBird'|'backpackFox'|'backpackFox2'} props.silhouette
...
function VisitMascotFallbackSvg({ silhouette = 'gnome', variant = 'forest' }) {
  switch (silhouette) {
    ...
    case 'backpackFox2':
      return <BackpackFox2VisitMascotSvg />;
    case 'spore':
