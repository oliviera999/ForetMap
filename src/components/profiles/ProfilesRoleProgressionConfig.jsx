  ...
  return (
    <>
      <div
        ...
        style={{ border: '1px solid #e0e7ff', background: '#f8fafc', borderRadius: 10, padding: 12, marginBottom: 14 }}
      >
        ...
        {isTier && (
          <div style={{ borderTop: '1px solid #e2e8f0', paddingTop: 10 }}>
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8, alignItems: 'center' }}>
              ...
              />
              <button type="button" className="btn btn-secondary btn-sm" onClick={onSaveMinDoneThreshold} disabled={loading}>
      ...
      {isTier && (
        <div
          ...
          style={{ border: '1px solid #d8f3dc', background: '#f1fcf4', borderRadius: 10, padding: 12, marginBottom: 14 }}
        >
          <div style={{ fontSize: '.88rem', fontWeight: 700, color: '#1b4332', marginBottom: 8 }}>Proposition de tâches</div>
          <label style={{ display: 'flex', alignItems: 'flex-start', gap: 10, fontSize: '.84rem', cursor: loading ? 'default' : 'pointer', marginBottom: 8 }}>
            <input
              type="checkbox"
          ...
          <label style={{ display: 'flex', alignItems: 'flex-start', gap: 10, fontSize: '.8rem', color: '#374151', cursor: loading || !proposeEntry ? 'default' : 'pointer' }}>
            <input
              type="checkbox"
      ...
      {isTier && (
        <div style={{ border: '1px solid #e0e7ff', background: '#f8fafc', borderRadius: 10, padding: 12, marginBottom: 14 }}>
          <div style={{ fontSize: '.88rem', fontWeight: 700, color: '#1e3a5f', marginBottom: 8 }}>
      ...
      {isTier && (
        <div style={{ border: '1px solid #fde68a', background: '#fffbeb', borderRadius: 10, padding: 12, marginBottom: 14 }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8, alignItems: 'center' }}>
            ...
            />
            <button type="button" className="btn btn-secondary btn-sm" onClick={onSaveMaxConcurrent} disabled={loading}>
