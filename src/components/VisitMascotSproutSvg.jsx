  ...
  return (
    <svg className="visit-sprout-svg" viewBox="0 0 128 148" role="presentation" focusable="false">
      ...
      <g className="visit-sprout-plant">
        <path
          d="M65 50 Q78 30 97 35 Q88 56 65 50 Z"
          fill="#84cc16"
          stroke="#3f6212"
          strokeWidth="2.2"
        />
        <path
          d="M62 54 Q46 36 29 42 Q42 62 62 54 Z"
          fill="#4ade80"
          stroke="#166534"
          strokeWidth="2.2"
        />
