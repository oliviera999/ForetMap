...
export function TaskTileMeta({
  ...
  return (
    <div className="task-meta">
      ...
      {!(t.zones_linked || []).length && t.zone_name && (
        <span className="task-chip">{t.zone_name}</span>
      )}
      ...
      {t.project_title && t.project_status === 'validated' && (
        <span className="task-chip">Validé (projet)</span>
      )}
