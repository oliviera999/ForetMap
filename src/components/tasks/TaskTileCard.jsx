...
import { taskStatusIndicator, dueDateChip, TaskDifficultyAndRiskChips, taskRequiresReferentBriefingBeforeStart } from '../../utils/badges';
import { taskEffectiveStatus, normalizeDateOnly } from '../../utils/taskListHelpers.js';
import {
  getAssignedCount,
  getAvailableSlots,
  getCompletionMode,
...
import { taskLivingBeingEmoji, formatAssigneeName, teacherCollectiveAssigneeLoadKey, toQuickAssignStudentId } from '../../utils/taskDisplayHelpers.js';
