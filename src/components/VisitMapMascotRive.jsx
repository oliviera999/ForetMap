  ...
  return (
    <svg className="visit-gnome-svg" viewBox="0 0 128 148" role="presentation" focusable="false">
      ...
      <g className="visit-gnome-hat">
        <path d="M34 40 L73 12 L100 37 L74 42 Z" fill="#2f855a" stroke="#1a4731" strokeWidth="4" />
        <circle cx="100" cy="37" r="4" fill="#fbbf24" stroke="#1a4731" strokeWidth="2" />
      </g>

      <g className="visit-gnome-head">
        <ellipse cx="68" cy="52" rx="20" ry="16" fill="#f4e9d0" stroke="#1a4731" strokeWidth="3.5" />
        ...
        <path d="M58 60 Q77 96 95 61 Q89 108 77 116 Q65 107 58 60 Z" fill="#fff8ef" stroke="#1a4731" strokeWidth="3" />
      </g>

      <g className="visit-gnome-body">
        <rect x="52" y="76" width="45" height="34" rx="13" fill="#6cc596" stroke="#1a4731" strokeWidth="4" />
        <rect x="71" y="78" width="8" height="27" rx="4" fill="#84512f" />
      </g>

      <g className="visit-gnome-arm visit-gnome-arm--back">
        <rect x="54" y="82" width="12" height="25" rx="6" fill="#f4e9d0" stroke="#1a4731" strokeWidth="3" />
      </g>
      <g className="visit-gnome-arm visit-gnome-arm--front">
        <rect x="85" y="81" width="12" height="25" rx="6" fill="#f4e9d0" stroke="#1a4731" strokeWidth="3" />
      </g>

      <g className="visit-gnome-leg visit-gnome-leg--back">
        <rect x="60" y="108" width="14" height="26" rx="7" fill="#6b4f2d" />
      </g>
      <g className="visit-gnome-leg visit-gnome-leg--front">
        <rect x="79" y="108" width="14" height="26" rx="7" fill="#6b4f2d" />
      </g>
    </svg>
  );
}
