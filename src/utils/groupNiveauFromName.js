 ...
 * Miroir ESM de `lib/pedago/groupNiveauFromName.js` (parité vérifiée par
 ...
 */
export const NAME_PATTERNS = Object.freeze({
...
export const VOIE_PATTERNS = Object.freeze({
...
export const YEAR_PREFIX_PATTERN = '^[0-9]{2,4} *# *';

/** Nom réduit à un chiffre (après le préfixe) : niveau brut correspondant. */
export const WHOLE_NAME_DIGIT = Object.freeze({
  1: 'premiere',
  2: 'seconde',
  3: 'cycle4',
  4: 'cycle4',
 ...
 */
export const SPECIAL_CHARS = Object.freeze({ ᵉ: 'e', ʳ: 'r', ᵈ: 'd', ⁿ: 'n', '°': 'e' });

/** Raisons renvoyées avec la proposition (affichées au professeur). */
export const SUGGESTION_REASONS = Object.freeze({
  deduit: 'deduit',
 ...
 */
export function suggestCurriculumNiveauFromName(name) {
...
export const AUTO_NIVEAU_GROUP_KINDS = Object.freeze(['class', 'unit']);
 ...
 * @returns {string|null}
 */
export function autoCurriculumNiveauForGroup({ name, kind, pedagoLevel } = {}) {
