...
export function readMarkerBackgroundsFromGameplaySettings(gameplaySettings = {}) {
  const raw =
    gameplaySettings.markerBackgrounds ?? gameplaySettings['gameplay.marker_backgrounds'];
...
export function markerBackgroundStyleFromSettings(gameplaySettings = {}) {
  return resolveMarkerBackgroundCssVars(readMarkerBackgroundsFromGameplaySettings(gameplaySettings));
}
