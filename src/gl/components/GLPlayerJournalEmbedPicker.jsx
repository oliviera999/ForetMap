...
export function GLPlayerJournalEmbedPicker({ open, onClose, onInsert, chapterSpells = [] }) {
  ...
  return (
    <div className="gl-action-modal gl-player-journal-embed-picker" role="dialog" aria-labelledby="gl-journal-embed-title" onClick={onClose}>
      <div
        className="gl-action-modal-body gl-player-journal-embed-picker__body"
