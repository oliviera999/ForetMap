...
export function GLPlayerJournalReadModal({ playerId, open, onClose }) {
  ...
  return (
    <div className="gl-action-modal gl-player-journal-read-modal" role="dialog" aria-labelledby="gl-journal-read-title" onClick={onClose}>
      <div
        className="gl-action-modal-body gl-profile-modal-body gl-player-journal-read-modal__body"
