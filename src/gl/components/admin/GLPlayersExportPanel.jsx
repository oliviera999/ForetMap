...
export function GLPlayersExportPanel({ classFilter }) {
  ...
  async function exportCsv() {
    ...
    try {
      ...
      const res = await fetch(withAppBase(`/api/gl/admin/players/export${query ? `?${query}` : ''}`), {
        method: 'GET',
        headers,
      });
      ...
      link.href = url;
      link.download = classFilter ? `foretmap-gl-joueurs-classe-${classFilter}.csv` : 'foretmap-gl-joueurs.csv';
      link.click();
