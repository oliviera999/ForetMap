...
const { readSheetRows } = require('./shared/xlsxImportCore');
...
function buildImportReportBase(dryRun, rowsCount) {
  return createImportReport({ dryRun, received: rowsCount, extraTotals: {} });
}
...
const resolveImportRows = (body = {}) =>
  resolveWorkbookImportRows(body, parseChapterCharteWorkbook);
