...
const ORIGIN_STATUS_VALUES = Object.freeze([
  'indigene',
  'introduit',
  'envahissant',
  'endemique',
 ...
 *
 * `endemique` n’est plus rabattu sur `indigene` depuis la migration 271 : l’arganier n’est
 * pas seulement indigène au Maroc, il n’existe nulle part ailleurs, et l’information se
 * perdait. Idem pour `domestique`, qui n’avait aucune case avant.
 */
const ORIGIN_STATUS_ALIASES = Object.freeze({
  ...
  endemic: 'endemique',
  endemique_maroc: 'endemique',
  domestique: 'domestique',
  domestiquee: 'domestique',
  domestic: 'domestique',
  domesticated: 'domestique',
  elevage: 'domestique',
  animal_de_ferme: 'domestique',
  introduit: 'introduit',
