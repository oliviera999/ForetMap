 ...
 *
 * Une seule source de restriction : le **périmètre de groupe** (`group_scopes.map_id`,
 * migration 079). La restriction individuelle (`users.affiliation`) a été retirée par la
 * migration 267 : modifiable par l'élève lui-même, elle ne bornait rien (CDG-16).
 *
 ...
 * pouvoir distinguer « aucune carte commune » de « non borné ».
 *
 * @param {string[]|null} a
 * @param {string[]|null} b
 * @returns {string[]|null}
