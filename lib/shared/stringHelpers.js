...
/** Texte optionnel : chaîne rognée, ou `null` si vide (cinq copies locales avant le 13/09/2026). */
function asOptionalText(value) {
  const s = asTrimmedString(value);
  return s.length > 0 ? s : null;
}

module.exports = { asTrimmedString, asOptionalText, normalizeImportHeader };
