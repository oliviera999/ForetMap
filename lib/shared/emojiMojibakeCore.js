...
/* Source : src/shared/emojiMojibakeCore.js — régénérer avec `npm run sync:shared-cores`. */
'use strict';
...
const GL_SOUFFLE_EMOJI = '🌫️';
const GL_TRAME_EMOJI = '🧵';
 ...
 * @returns {string}
 */
function repairSupplementaryPlaneEmojiMojibake(value) {
...
module.exports = {
  GL_SOUFFLE_EMOJI,
  GL_TRAME_EMOJI,
  repairSupplementaryPlaneEmojiMojibake,
};
