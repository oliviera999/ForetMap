...
const LEGACY_SCAFFOLDING_COLUMNS = Object.freeze([
  ...
  // Complément réservé unique par lieu → table `location_notes` (migration 263).
  // Le fichier de schéma doit continuer de déclarer ces colonnes : les migrations 236, 240
  // et 262 les lisent ou les écrivent, et échoueraient sur une base neuve sans elles. C'est
  // donc ici, après les migrations, qu'elles sont retirées — sinon le fichier de schéma les
  // recréerait au démarrage suivant, la migration 263 étant déjà passée.
  { table: 'zones', column: 'restricted_note' },
  { table: 'zones', column: 'restricted_note_role_slugs' },
  { table: 'zones', column: 'restricted_note_group_ids' },
  { table: 'map_markers', column: 'restricted_note' },
  { table: 'map_markers', column: 'restricted_note_role_slugs' },
  { table: 'map_markers', column: 'restricted_note_group_ids' },
  { table: 'visit_zones', column: 'restricted_note' },
  { table: 'visit_zones', column: 'restricted_note_role_slugs' },
  { table: 'visit_zones', column: 'restricted_note_group_ids' },
  { table: 'visit_markers', column: 'restricted_note' },
  { table: 'visit_markers', column: 'restricted_note_role_slugs' },
  { table: 'visit_markers', column: 'restricted_note_group_ids' },
  // Politique de profil unique (migration 266) : le drapeau « accorde n3beur », la
  // restriction de cartes individuelle et le rôle de membre disparaissent. Les migrations
  // 024, 076, 079, 146, 167 et 265 les lisent ou les écrivent sur une base neuve : le fichier
  // de schéma les déclare encore, et c'est ici qu'elles sont retirées.
  { table: 'groups', column: 'grants_n3beur_access' },
  { table: 'users', column: 'affiliation' },
  { table: 'group_members', column: 'role_in_group' },
]);
