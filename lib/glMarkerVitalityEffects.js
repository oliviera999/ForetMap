...
const { parseVitalityDelta, applyTeamVitalityDelta, applyPlayerVitalityDelta } = require('./glVitality');
  ...
  const alreadyApplied =
    typeof checkAlreadyApplied === 'function'
      ...
      : skipIfAlreadyApplied
        ? await hasMarkerVitalityApplied({ queryAll: tx.queryAll.bind(tx) }, { gameId, teamId, markerId: marker.id })
        : false;
