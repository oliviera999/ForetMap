...
/**
 * Vérifie que chaque joueur ciblé appartient bien à l'équipe de la partie.
 * Empêche un appelant de débiter/créditer un `gl_players.id` hors roster
 * (autre équipe, autre classe, ou compte hors partie).
 */
