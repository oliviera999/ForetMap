 ...
 *
 * `quiz_question_tutorials` n'y figure plus (temps 2 du retrait, audit du 25/09/2026, § 3.5) :
 * les liens question ↔ tutoriel vivent dans `resource_question_links`, repointé plus bas. Les
 * lignes figées de l'ancienne table disparaissent avec le doublon (`ON DELETE CASCADE`).
 */
...
const POLYMORPHIC_TABLES = Object.freeze([
  'resource_question_links',
  'resource_gating_policy',
  // Verrous de re-tentative : oubliés jusqu'au lot 6 de l'audit validation quiz (C7) — un
  // élève bloqué sur un doublon supprimé l'était sur une fiche fantôme.
