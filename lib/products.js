...
const PRODUCTS = Object.freeze({
  ...
  plan: Object.freeze({
    ...
    htmlEntry: 'plan.html',
    assetsDir: 'plan',
    // Favicon propre sous public/plan/ (charte bleue Lycée Lyautey) — pas de shareFaviconWith.
    apiPrefix: '/api/plan',
    authRateLimitPaths: Object.freeze([]),
    swFile: 'sw-plan.js',
  ...
  /**
   * Plan des personnels (`proflyautey.*`) : même carte et même écran que le Plan Lyautey, mais
   ...
   * établissement, mêmes icônes d'installation, aucun binaire dupliqué. Seules la teinte, le
   * titre et le favicon SVG (`public/staff/favicon.svg`, référencé par `staff.html`) changent,
   * pour distinguer les deux onglets côte à côte.
   */
  staff: Object.freeze({
    id: 'staff',
    label: 'Plan personnels',
    hostPrefixes: Object.freeze(['proflyautey.']),
    ...
    pwa: Object.freeze({
      name: 'Plan personnels — Lyautey',
      shortName: 'Plan perso.',
      description: 'Plan du Lycée Lyautey réservé aux personnels : lieux et consignes internes',
      themeColor: '#5a3a12',
