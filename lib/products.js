 ...
 *   de l'entrée HTML réutilisent l'icône de cet autre produit (Plan Lyautey = ForetMap).
...
const PRODUCTS = Object.freeze({
  ...
  plan: Object.freeze({
    ...
    htmlEntry: 'plan.html',
    assetsDir: 'plan',
    // Même arbre n³ / vert forêt que ForetMap (pas d'identité visuelle distincte pour l'onglet).
    shareFaviconWith: 'foret',
    apiPrefix: '/api/plan',
    authRateLimitPaths: Object.freeze([]),
    swFile: 'sw-plan.js',
