...
async function getFmGatingSite() {
  return {
    ...
    allowedWrongAttempts: await getSettingValue('learning.gating.allowed_wrong_attempts', 0),
    maxQuestionsPerSession: await getSettingValue('learning.gating.max_questions_per_session', 3),
    announceOnButton: await getSettingValue('learning.gating.announce_on_button', true),
  };
}
