...
async function runAutoArchiveJob(opts = {}) {
  ...
  // Date-butoir calculée côté JS (paramètre Date classique) plutôt que `INTERVAL ? DAY`
  // en requête préparée, dont le support varie selon les versions MySQL/MariaDB.
