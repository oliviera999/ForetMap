...
/** Scènes de récit par chapitre (pays 1–5) + prologue — convention `recit_0N-chapN_*`. */
const CHAPTER_RECIT_REFS = [
  { ref: 'prologue', prefix: 'recit_00-prologue_' },
  ...Array.from({ length: 5 }, (_, index) => ({
    ref: `chap${index + 1}`,
    prefix: `recit_0${index + 1}-chap${index + 1}_`,
  })),
];
