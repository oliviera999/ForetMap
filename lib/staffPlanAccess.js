 ...
 * groupe actif confère le sien dès qu'il est de rang supérieur, et « Personnel » est le profil
 * de plus bas rang du catalogue (50, sous `n3beur novice`). Un personnel rattaché à un groupe
 * — vie scolaire suivant une classe, agent inscrit à un projet — se retrouvait donc avec un
 * profil effectif d'élève, sans `staff_plan.access` ni case cochée : « Connexion réussie, mais
 * ce compte n'a pas encore l'accès au plan des personnels », alors que sa fiche affichait bien
 * « Personnel ». Le profil attribué est la déclaration de l'administrateur sur *qui est cette
 * personne* ; un groupe est là pour élever ses capacités dans ForetMap, pas pour lui retirer sa
