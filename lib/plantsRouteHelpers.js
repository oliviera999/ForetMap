...
/**
 * Danger (migration 251) — gravité, voies d'exposition, conduite à tenir, et drapeau de
 * relecture. Groupés à part des champs de détermination : la détermination répond à
 * « qu'est-ce que c'est », le danger à « qu'est-ce que ça peut me faire », et une espèce
 * parfaitement identifiée peut rester dangereuse.
 */
const PLANT_HAZARD_FIELDS = [
  'toxicity_level',
  'hazard_exposure',
  'hazard_notes',
  'hazard_reviewed',
