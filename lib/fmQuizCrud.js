...
async function syncSingleQuestionGlossaryLinks(deps, payload) {
  ...
  // par mots-clés ne remplace **que ses propres liens** (origin='keyword', migration 293) : les
  // liens relus à la main — dont la curation de la migration 227, stockée sous
  // origin='import' et rendue bloquante — et ceux des scripts d'enrichissement
  // ('generated'/'auto') ne sont jamais touchés (audit du 25/09/2026, § 1.3.3). INSERT IGNORE :
  // un lien déjà présent (relu, bloquant) n'est pas rétrogradé.
  await execute(
