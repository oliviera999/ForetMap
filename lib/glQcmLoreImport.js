...
async function syncGlossaryLinks(validRows, deps, dryRun) {
  ...
  if (!dryRun) {
    // DELETE scopé : ne supprime QUE les liens lore_glossary approuvés (préserve species/feuillet/glossary
    // et les liens 'suggested'). Source de vérité unifiée : gl_resource_question_links (cf. migration 145).
    await execute(
