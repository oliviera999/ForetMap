...
async function settleTradeInTx(tx, tradeId) {
  ...
  // Second verrou : une offre en cœurs a pu être posée avant que le réglage ne
  // bascule. On refuse la finalisation plutôt que d'ignorer silencieusement une
  // partie de l'offre acceptée par les deux joueurs.
