 ...
 * Partagé par `POST/PUT /api/tasks` et `POST /api/tasks/proposals` — une date d’un autre
 * format se glisserait sinon dans la colonne `VARCHAR(32)` et ferait échouer la
 * récurrence en silence (`parseISODateOnly` n’accepte que ce format).
