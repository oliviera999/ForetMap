...
function rectPixelsToPolygonPoints(x, y, width, height, mapW = DEFAULT_MAP_WIDTH, mapH = DEFAULT_MAP_HEIGHT) {
  const x0 = Number(x);
  const y0 = Number(y);
...
function circlePixelsToPolygonPoints(x, y, width, height, mapW = DEFAULT_MAP_WIDTH, mapH = DEFAULT_MAP_HEIGHT) {
  const x0 = Number(x);
  const y0 = Number(y);
  const w = Number(width);
  const h = Number(height);
...
function ellipsePixelsToPolygonPoints(x, y, width, height, mapW = DEFAULT_MAP_WIDTH, mapH = DEFAULT_MAP_HEIGHT) {
