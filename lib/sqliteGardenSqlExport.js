...
/**
 * Un `Date` — ce que mysql2 renvoie pour les colonnes passées en DATETIME(3) par la
 * migration 254 — doit sortir au format MySQL. `String(date)` produirait
 * « Tue Sep 15 2026 19:12:05 GMT+0000 (…) », que le fichier exporté ne pourrait pas
 * réimporter.
 */
