 ...
 * ## La traduction
 *
 * Elle a lieu **une seule fois**, au démarrage, juste après le semis (il faut que les lignes
 * existent pour pouvoir les dépublier). Elle reporte la restriction en cours sur `is_published`,
 * puis **efface le réglage** — ce qui est aussi sa marque de passage : une fois vide, il n'y a
