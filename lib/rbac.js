...
const SYSTEM_ROLES = [
  ...
  { slug: 'prof', display_name: 'Prof', rank: 400, display_order: 20 },
  { slug: 'eleve_chevronne', display_name: 'Élève chevronné', rank: 300, emoji: '🏆', min_done_tasks: 10, display_order: 30 },
  { slug: 'eleve_avance', display_name: 'Élève avancé', rank: 200, emoji: '🌿', min_done_tasks: 5, display_order: 40 },
  { slug: 'eleve_novice', display_name: 'Élève novice', rank: 100, emoji: '🪨', min_done_tasks: 0, display_order: 50 },
...
const STUDENT_PROGRESS_DEFAULTS = {
  eleve_novice: { min: 0, emoji: '🪨', order: 50, label: 'Élève novice' },
  eleve_avance: { min: 5, emoji: '🌿', order: 40, label: 'Élève avancé' },
  eleve_chevronne: { min: 10, emoji: '🏆', order: 30, label: 'Élève chevronné' },
};
