...
const rbacCache = require('./rbacCache');
...
async function getRolePermissions(roleId) {
  // Cache partagé par roleId (cf. lib/rbacCache.js) : invalidé au niveau couche données dès
  // qu'une écriture touche une table RBAC (y compris SQL direct des tests/dédup).
  return rbacCache.getCachedRolePermissions(roleId, () =>
    queryAll(
