...
async function resolveRoleFromGroupRow(groupRow) {
  if (groupRow?.default_role_id_resolved) {
    return {
      roleId: groupRow.default_role_id_resolved,
      roleSlug: groupRow.default_role_slug,
      roleDisplayName: groupRow.default_role_display_name,
      rank: Number(groupRow.default_role_rank || 0),
    };
  }
