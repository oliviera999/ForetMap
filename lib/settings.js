...
const SETTINGS_REGISTRY = {
  ...
  /**
   * Porte d'entrée **par compte**. Liste de profils (slugs, séparés par `;`) autorisés à
   * ouvrir proflyautey. Défaut = ceux qui avaient `staff_plan.access` à la livraison.
   * Un profil du catalogue décoché ici est refusé même s'il a encore la permission RBAC ;
   * un profil maison hors catalogue continue de s'appuyer sur `staff_plan.access`.
   * Portée `admin` — ne figure pas dans la charge publique.
   */
