...
const SETTINGS_REGISTRY = {
   ...
   * pour que rien ne change sur un site existant. Éteint → onglet masqué (élève et prof) et
   * routes du module en 503, comme le forum (`lib/shared/moduleGate.js`).
   */
  ...
  /** Badges de fin de séance : éteint → aucune attribution, lecture `/api/rewards` en 503. */
