...
const SETTINGS_REGISTRY = {
  ...
  /**
   * Essais RATÉS tolérés sur une ressource avant que le verrou ne tombe.
   * 0 = verrou dès la première erreur (comportement historique). Sans cette
   * tolérance, le conditionnement n'avait que deux régimes possibles : brutal
   * (verrou immédiat) ou nul (délai à 0 = réessais illimités jusqu'à tomber juste).
   */
  ...
  /**
   * Nombre maximum de questions posées d'affilée en une session de validation.
   * En mode « toutes », une ressource portant huit questions bloquantes les
   * enchaînait sans plafond. Les bonnes réponses restent acquises d'une session
   * à l'autre : l'élève progresse par paliers au lieu de subir un marathon.
   */
  ...
  /**
   * Annoncer sur le bouton lui-même qu'un contrôle attend (« 2 questions »).
   * Sans cela, l'élève ne découvre l'épreuve qu'après avoir cliqué.
   */
  'learning.gating.announce_on_button': { scope: 'teacher', type: 'boolean', default: true },
