...
// est COMMUN aux deux produits. Ce qui les distingue était tranché par une quarantaine de
// `product === 'gl'` dispersés dans onze fichiers. C'est désormais décrit ici, UN OBJET PAR
// PRODUIT (`GATING_PRODUCTS.fm`, `GATING_PRODUCTS.gl`) :
//
