 ...
 * Normalisation/lookup/matching partagés avec le glossaire lore via
 * `lib/shared/glossaryNormalization.js` (audit §4.2, paire 1.5) ;
 * champ code ici : `glossary_code`.
 */
 ...
 */
const buildGlossaryLookupMap = buildLookupMap;
