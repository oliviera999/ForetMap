...
function validateImportStudentPayload(payload, rowNumber, opts = {}) {
  ...
  if (!payload.roleSlug || !IMPORT_ROLE_SLUGS.has(payload.roleSlug)) {
    errors.push({
      ...
      field: 'role',
      error:
        'Rôle invalide (visiteur, personnel, eleve_novice, eleve_avance, eleve_chevronne, prof_classe, prof, admin)',
    });
  }
...
function buildTemplateWorkbookRows() {
  ...
  return [
    ...
    },
    {
      ...
      [col[4]]: 'both',
      [col[5]]: 'Personnel',
      [col[6]]: 'exemple_personnel',
      [col[7]]: 'exemple.personnel@lyautey.ma',
      [col[8]]: 'Exemple personnel (même parcours que visiteur). Remplacer ou supprimer.',
    },
    {
      [col[0]]: 'eleve_novice',
      [col[1]]: 'Novice',
