 ...
 * @param {{ minPasswordStudent?: number, minPasswordTeacher?: number }} [opts]
 */
function validateImportStudentPayload(payload, rowNumber, opts = {}) {
  const errors = [];
  const minStudent = Number(opts.minPasswordStudent) > 0 ? Number(opts.minPasswordStudent) : 4;
  const minTeacher =
...
function buildTemplateWorkbookRows() {
  ...
  return [
    {
      [TEMPLATE_COLUMNS[0]]: 'visiteur',
      [TEMPLATE_COLUMNS[1]]: 'Visite',
      [TEMPLATE_COLUMNS[2]]: 'Exemple',
      [TEMPLATE_COLUMNS[3]]: studentPwd,
      [TEMPLATE_COLUMNS[4]]: 'both',
      [TEMPLATE_COLUMNS[5]]: 'exemple_visiteur',
      [TEMPLATE_COLUMNS[6]]: 'exemple.visiteur@gmail.com',
      [TEMPLATE_COLUMNS[7]]:
        'Exemple visiteur — e-mail hors domaine établissement OK à l’import. Remplacer ou supprimer.',
    },
    {
      [TEMPLATE_COLUMNS[0]]: 'eleve_novice',
      [TEMPLATE_COLUMNS[1]]: 'Novice',
      [TEMPLATE_COLUMNS[2]]: 'Exemple',
      [TEMPLATE_COLUMNS[3]]: studentPwd,
      [TEMPLATE_COLUMNS[4]]: 'n3',
      [TEMPLATE_COLUMNS[5]]: 'exemple_novice',
      [TEMPLATE_COLUMNS[6]]: 'exemple.novice@lyautey.ma',
      [TEMPLATE_COLUMNS[7]]:
        'Exemple n3beur novice (alias acceptés : eleve, n3beur). Remplacer ou supprimer.',
    },
    {
      [TEMPLATE_COLUMNS[0]]: 'eleve_avance',
      [TEMPLATE_COLUMNS[1]]: 'Avance',
      [TEMPLATE_COLUMNS[2]]: 'Exemple',
      [TEMPLATE_COLUMNS[3]]: studentPwd,
      [TEMPLATE_COLUMNS[4]]: 'foret',
      [TEMPLATE_COLUMNS[5]]: 'exemple_avance',
      [TEMPLATE_COLUMNS[6]]: 'exemple.avance@example.org',
      [TEMPLATE_COLUMNS[7]]: 'Exemple n3beur avancé. Remplacer ou supprimer.',
    },
    {
      [TEMPLATE_COLUMNS[0]]: 'eleve_chevronne',
      [TEMPLATE_COLUMNS[1]]: 'Chevronne',
      [TEMPLATE_COLUMNS[2]]: 'Exemple',
      [TEMPLATE_COLUMNS[3]]: studentPwd,
      [TEMPLATE_COLUMNS[4]]: 'both',
      [TEMPLATE_COLUMNS[5]]: 'exemple_chevronne',
      [TEMPLATE_COLUMNS[6]]: 'exemple.chevronne@proton.me',
      [TEMPLATE_COLUMNS[7]]: 'Exemple n3beur chevronné. Remplacer ou supprimer.',
    },
    {
      [TEMPLATE_COLUMNS[0]]: 'prof_classe',
      [TEMPLATE_COLUMNS[1]]: 'Classe',
      [TEMPLATE_COLUMNS[2]]: 'Exemple',
      [TEMPLATE_COLUMNS[3]]: teacherPwd,
      [TEMPLATE_COLUMNS[4]]: 'both',
      [TEMPLATE_COLUMNS[5]]: 'exemple_prof_classe',
      [TEMPLATE_COLUMNS[6]]: 'exemple.profclasse@outlook.com',
      [TEMPLATE_COLUMNS[7]]:
        'Exemple prof de classe — mot de passe ≥ 12 car. Remplacer ou supprimer.',
    },
    {
      [TEMPLATE_COLUMNS[0]]: 'prof',
      [TEMPLATE_COLUMNS[1]]: 'N3boss',
      [TEMPLATE_COLUMNS[2]]: 'Exemple',
      [TEMPLATE_COLUMNS[3]]: teacherPwd,
      [TEMPLATE_COLUMNS[4]]: 'both',
      [TEMPLATE_COLUMNS[5]]: 'exemple_n3boss',
      [TEMPLATE_COLUMNS[6]]: 'exemple.n3boss@lyautey.ma',
      [TEMPLATE_COLUMNS[7]]:
        'Exemple n3boss (alias : professeur, teacher). Remplacer ou supprimer.',
    },
    {
      [TEMPLATE_COLUMNS[0]]: 'admin',
      [TEMPLATE_COLUMNS[1]]: 'Admin',
      [TEMPLATE_COLUMNS[2]]: 'Exemple',
      [TEMPLATE_COLUMNS[3]]: teacherPwd,
      [TEMPLATE_COLUMNS[4]]: 'both',
      [TEMPLATE_COLUMNS[5]]: 'exemple_admin',
      [TEMPLATE_COLUMNS[6]]: 'exemple.admin@example.com',
      [TEMPLATE_COLUMNS[7]]:
        'Exemple administrateur — réservé à un importateur admin. Remplacer ou supprimer.',
    },
  ];
}
