...
/**
 * Ré-authentification avant un changement de mot de passe (la modification de profil,
 * elle, se contente de la session).
 *
...
function readProfileFieldFlags(body) {
  const flags = {
    ...
    hasBiodivPedagoLevel: hasOwn(body, 'biodiv_pedago_level'),
