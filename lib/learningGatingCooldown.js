...
// (reglage, defaut 6 h — il se reglait en jours, defaut 3 j, jusqu'au lot 2 de
...
/** Borne le delai de verrou en HEURES (0 = desactive). */
function clampCooldownHours(value, fallback = 6) {
