...
const { parseOptionalBoolean } = require('./adminRouteHelpers');
...
function parseChapterMapVisibilityField(value) {
...
/** Slug canonique de chapitre : minuscules + rognage (alias historique de `lowerTrim`). */
const normalizeSlug = lowerTrim;
