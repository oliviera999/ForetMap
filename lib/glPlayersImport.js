...
const TEMPLATE_SAMPLE_ROW = [
  'Aurore',
  'Dupont',
  // `example.org` (domaine réservé par la RFC 2606, donc jamais attribuable) et non celui de
  // l'établissement : le gabarit est versionné dans un dépôt, et `prénom.nom@<domaine réel>`
  // y publierait la convention de nommage des comptes — de quoi énumérer des adresses valides
  // sans rien deviner. Les professeurs remplacent la ligne d'exemple par leurs vraies données.
  'aurore.dupont@example.org',
  'equipe_aurore',
  'azerty123',
  '6e A',
];
