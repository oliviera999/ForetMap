...
function normalizePolicy(raw, index) {
  ...
  // Tout profil ForetMap peut être conféré par un groupe (les politiques sont réservées à
  // l'administrateur) ; seuls les profils du jeu Gnomes & Licornes restent hors de portée.
  if (role && role.startsWith('gl_')) {
