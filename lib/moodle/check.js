...
const SITE_INFO_ACCESS_HINTS = Object.freeze({
  ...
  // La sonde échoue elle aussi : rien n'est accessible avec ce jeton.
  global:
    'Aucune fonction n’est accessible avec ce jeton : vérifier que le protocole REST est activé, ' +
    'que le compte de service figure dans « Utilisateurs autorisés » du service externe, et qu’il ' +
    'possède la capacité webservice/rest:use. Vérifier aussi la restriction d’adresse IP du jeton.',
