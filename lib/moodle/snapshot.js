...
/**
 * Lecture Moodle d'une exécution : cohortes de l'année retenues par une politique, membres,
 * détails des comptes. Aucune écriture. Les cohortes sans politique sont listées, pas traitées.
 */
...
async function fetchMoodleSnapshot({ client, settings, scope = {} }) {
  ...
  for (const raw of all) {
    ...
    if (!isCohortOfYear(idnumber, settings.yearPrefix)) continue;
