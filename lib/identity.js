...
async function resolveLoginAccountByIdentifier(identifier) {
  ...
  // Une seule identité, quel que soit le produit : le pseudo de jeu Gnomes & Licornes ouvre
  // aussi ForetMap (le pseudo du compte miroir peut différer, suffixé en cas de collision).
