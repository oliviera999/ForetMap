 ...
 *
 * Si l'équipe du receveur possède déjà le feuillet, on ne réécrit pas son état :
 * `upsertFeuilletState` écraserait sinon l'effacement et `unlocked_via` (une
 * découverte d'exploration reclassée en échange, ou un feuillet lisible
 * remplacé par une copie plus effacée).
 */
