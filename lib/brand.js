 ...
 * - les **préfixes de host** du registre produits (`planlyautey.`, `proflyautey.`) : c'est du
 *   routage de déploiement, pas de l'affichage. Servir le Plan sur un autre domaine demande le
 *   champ `hosts` exact décrit dans `docs/reference/exploitation/marque-et-domaines.md` ;
