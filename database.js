...
async function seedData() {
  ...
  if (plantsCount === 0) {
    ...
    const insertPlantSql = `
      INSERT INTO plants (
        name, emoji, description, second_name, scientific_name,
        habitat, photo, nutrition, remark_1, remark_2, remark_3,
        reproduction, size, sources, ecosystem_role, geographic_origin,
