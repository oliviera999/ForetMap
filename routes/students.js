...
router.post('/import', requirePermission('students.import', { needsElevation: true }), asyncHandler(async (req, res) => {
...
router.post('/:id/duplicate', requirePermission('users.create', { needsElevation: true }), asyncHandler(async (req, res) => {
