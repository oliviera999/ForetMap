...
| `FORETMAP_DISABLE_RECURRING_TASK_JOB` | Optionnel : `1` pour ne planifier **aucun** job quotidien — tâches récurrentes **et** archivage automatique (hors `NODE_ENV=test`, qui les désactive déjà).       |
