...
### Ajouté
- **Tâches & tutoriels par lieu** : un clic sur une **zone** ou un **repère** ouvre l’onglet **Tâches** (vue carte seule) avec le filtre lieu prérempli ; en vue **Cartes & tâches** (split), le panneau tâches se met au même filtre. L’onglet s’intitule **Tâches et tuto** lorsque le module tutoriels est actif ; bloc **Tutoriels pour ce lieu** (liste, **Consulter** côté élève ; **Lier** / **Délier** côté prof). Le sélecteur de lieu inclut aussi les zones/repères qui n’ont que des tutoriels. **`App.jsx`**, **`map-views.jsx`**, **`tasks-views.jsx`**.
