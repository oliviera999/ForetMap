...
- **Affichage**: `PlantViewer`/`PlantMetaSections` côté frontend, avec miniatures directes pour URLs image et prévisualisation Wikimedia.

Conclusion: ce flux est "URL-only". Il ne charge ni n'écrit de fichiers image côté serveur.
