...
| [`AUDIT_SUITE_E2E_2026-09-17.md`](../AUDIT_SUITE_E2E_2026-09-17.md)                               | Pourquoi la suite e2e était rouge (88/14/1) et depuis quand — quatorze specs périmées, aucune régression applicative                                                                                                                                     | Instantané 17 sept. 2026 — **14 échecs réparés** ; trois points de fond ouverts (§ 4)                                                                                                                               |
...
| [`AUDIT_COMMUNICATION_2026-09-18.md`](../AUDIT_COMMUNICATION_2026-09-18.md)                       | Communication entre utilisateurs : canaux existants, six angles morts (aucune notification serveur, aucun destinataire), options chiffrées                                                                                                               | Instantané 18 sept. 2026 — **cadrage** ; lot 0 livré, C1–C8 à arbitrer                                                                                                                                              |
| [`AUDIT_COMPTES_DROITS_GROUPES_2026-09-18.md`](../AUDIT_COMPTES_DROITS_GROUPES_2026-09-18.md)     | Comptes, profils RBAC, groupes, sessions, pont G&L, Moodle/LTI, front « Profils & utilisateurs » : escalades, bugs, écarts doc ↔ code, dette                                                                                                             | Instantané 18 sept. 2026 — **à traiter** (5 bloquants, lots A–E proposés)                                                                                                                                           |
| [`AUDIT_SECURITE_2026-09-22.md`](../AUDIT_SECURITE_2026-09-22.md)                                 | **Sécurité d'accès aux données** des trois surfaces (foretmap / planlyautey / proflyautey) : politique d'accès serveur, `hidden_surfaces`, EXIF, PWA, socket.io — inventaire des routes **mesuré**                                                       | 22 sept. 2026 — **P0 (A–E) et M livrés**, S1–S6 et S12 traités avec tests ; S7–S11 ouverts (lots F–L). **Alerte publication : dump de production dans l'historique Git (§12)**                                      |
| [`AUDIT_ETAT_DES_LIEUX_2026-09-25.md`](../AUDIT_ETAT_DES_LIEUX_2026-09-25.md)                     | **État des lieux général hors GL** : cartographie, correspondance base ↔ code (matrice CSV jointe), points chauds (niveaux, verrouillage, liens, présence, observations, `plants`), qualité, sécurité, pistes A–D et plan de refactorisation par domaine | 25 sept. 2026 — **décisions du mainteneur reçues** (§ Décisions) ; mise en œuvre P0 + pistes en cours Déploiement côté serveur : [`RUNBOOK_DEPLOIEMENT_AUDIT_2026-09.md`](../RUNBOOK_DEPLOIEMENT_AUDIT_2026-09.md). |
