...
**Complément (2026-09-07).** L'audit [`docs/AUDIT_VALIDATION_QUIZ_2026-09.md`](../AUDIT_VALIDATION_QUIZ_2026-09.md) (les deux applications, tous les aspects) a relevé que le verrou après erreur ne tenait qu'à la bonne volonté de l'écran (contournable depuis le Quiz libre), que la portée « seulement la question ratée » n'était relue nulle part, que les propositions automatiques devenaient bloquantes d'un clic d'approbation en lot, et que plusieurs écrans avaient des défauts (focus qui s'échappe, erreurs affichées brutes, pastilles non rafraîchies, préréglages par type affichés en valeurs de repli). Tout cela est **livré** : verrou contraignant avec une **sévérité** réglable par type (souple / normale / stricte), délai **en heures (6 h par défaut)**, portée « question seule » fonctionnelle, règle unique « une proposition ne conditionne jamais, seul un clic “bloquant” le fait », écrans de réglage réécrits en quatre étapes avec aide en clair, dans les deux produits. Reste ouvert côté G&L : le sélecteur de ressources avec titres dans l'écran des liens et le contrôle d'existence à la création (J3), suivi dans l'audit.
