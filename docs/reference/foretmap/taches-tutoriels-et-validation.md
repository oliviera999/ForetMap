...
2. **Des questions du Quiz sont rattachées au tutoriel**, **approuvées** ET cochées
   **bloquantes**, dans l'écran « Rattacher des questions aux contenus » (onglet Quiz, côté
   ...
   Une question **désactivée** ne conditionne rien, même rattachée « bloquante » : l'écran ne
...
| Portée du blocage                               | **La fiche entière par défaut** (comportement historique), ou la **seule question ratée** — l'élève poursuit alors sur les autres questions de la fiche, chaque question ratée portant son propre délai et sa propre tolérance ; la fiche n'attend que s'il ne reste plus aucune question à poser. Utile surtout avec l'exigence « toutes » ou « seuil ». _Ce réglage n'avait aucun effet avant septembre 2026 : choisi, il supprimait tout verrou._                                                                |
