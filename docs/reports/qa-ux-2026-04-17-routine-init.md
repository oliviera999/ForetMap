# Rapport QA UX Personae - ForetMap

- Date: 2026-04-17
- Auteur: a completer
- Perimetre (lot/PR/commit): initialisation routine QA personae
- Environnement (URL, device, navigateur): a completer
- Version app (si connue): a completer
...
Critere de classement recommande:
...
- Cas non reproductibles / a verifier
- Captures d'ecran
