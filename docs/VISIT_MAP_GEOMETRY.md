...
6. **Assets spritesheet** : OLU `public/assets/mascots/olu/olu-spritesheet.png` ; oiseau tan `public/assets/mascots/tan-bird/tan-bird-spritesheet.png` ; renard sac (grille **153×160**, atlas **918×640**) `public/assets/mascots/fox-backpack/fox-backpack-spritesheet.png` — régénération possible avec `node scripts/normalize-fox-backpack-spritesheet.cjs <source.png>`.
