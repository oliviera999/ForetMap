...
| B   | **Socle posé** — B1 échelle 7 crans (`--text-xs…2xl`) + `--fw-*` / `--lh-*` ; B4 petits boutons alignés (0.875rem / 36 px partout, `line-height:1.25` sur `.btn`) ; B5 piles de polices dédupliquées (une définition par produit). **Reste** : B2 migration des 879 tailles littérales vers les tokens (par rafales, avec règle lint) et B3 résorption des styles inline — lots dédiés.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| C   | **Traité sauf C4** — C1 repères Visite compensés (`compensateWorldScale`, pastilles ÷ échelle via `--map-overlay-world-inv`) ; C2 GL reçoit `isCoarsePointer` + préférence « Aa », le réglage « Aa » est exposé sur la Visite ; C5 arrondi après division et plancher appliqué au couple (ratio conservé). **Reste** : C4 colonne `zones.emoji` dédiée (migration de schéma, lot dédié) et le rattachement du `16px` du réseau trophique (C3 partiel : feuillets GL corrigés via A4).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| D   | À planifier (arbitrages produit : D1a regroupement d'onglets, C6 icônes SVG) — D1c entamé au passage (`×` → `✕`, feuille de filtres carte alignée sur celle des tâches).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
