...
Avec **`npm run dev`**, ouvrir **`/mascot-pack-tool.html`** : édition JSON, validation, prévisualisation, copie / téléchargement du pack. Voir [`docs/LOCAL_DEV.md`](LOCAL_DEV.md).
