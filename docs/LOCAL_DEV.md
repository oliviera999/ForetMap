...
### Régressions sécurité et intégrité post-audit
...
des routes réservées aux n3beurs : un compte inscrit sans groupe démarre en profil `visiteur`, donc
les journaux et actions n3beur protégées peuvent répondre **403**.
