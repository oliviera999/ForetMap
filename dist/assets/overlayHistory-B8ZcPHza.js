...
`.substring(0,o)+a}function q(e){return e!=null&&(typeof e==`string`||e.nodeType&&(e.nodeType===1||e.nodeType===9||e.nodeType===11))}var J=[],Y=0,X=!1,Z={active:!1,budget:0,fallbackId:null};function Q(){Z.fallbackId!=null&&(clearTimeout(Z.fallbackId),Z.fallbackId=null)}function $(){Z.active=!1,Z.budget=0,Q()}function ee(){typeof window>`u`||($(),Z.active=!0,Z.budget=12,Z.fallbackId=window.setTimeout(()=>$(),1e4))}function te(){if(Z.active&&Z.budget>0){--Z.budget;return}if(Y>0){--Y;return}let e=J.pop();if(typeof e==`function`)try{e()}catch{}}function ne(){X||(X=!0,window.addEventListener(`popstate`,te))}function re(e){typeof window>`u`||typeof e!=`function`||(ne(),window.history.pushState({foretmapOverlay:!0},``,window.location.href),J.push(e))}function ie(e){if(typeof window>`u`||typeof e!=`function`)return;let t=J.lastIndexOf(e);t!==-1&&t===J.length-1&&(J.pop(),Y=1,window.history.back())}function ae(){if(typeof window>`u`)return;let e=J.length;e!==0&&(J=[],Y=e,window.history.go(-e))}export{ie as a,re as i,ee as n,H as o,$ as r,ae as t};